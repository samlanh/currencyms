...
class Application_Model_DbTable_DbGlobal extends Zend_Db_Table_Abstract
{
	...
	public function getAllMonths($id=null){
		$tr= Application_Form_FrmLanguages::getCurrentlanguage();
		$opt_month = array(''=>'----ជ្រើសរើស----',1=>'មករា',2=>'កុម្ភះ',3=>'មីនា',4=>'មេសា',5=>'ឧសភា',
...
//     	echo $newfile;exit();
    ...
    public function getVillage(){
    	...
    	$sql = " SELECT vill_id AS id,village_name AS name,commune_id FROM $this->_name WHERE status=1 AND village_name!='' ";
    	$db = $this->getAdapter();
    	return $db->fetchAll($sql);
    }
