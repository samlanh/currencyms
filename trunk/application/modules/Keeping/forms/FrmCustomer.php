...
class Keeping_Form_FrmCustomer extends Zend_Dojo_Form
{
	protected $tr=null;
...
//    			'class'=>'fullside',
    	...
    	$id_accournnumber = $db->getNewAccountNumber(2);
    	...
    	$status_tran->setAttribs(array(
    			'dojoType'=>'dijit.form.FilteringSelect'));
    	$status_option=array(2=>'ទូទាត់ខាងក្រៅ',1=>'ប្រើប្រាស់សាច់ប្រាក់');
