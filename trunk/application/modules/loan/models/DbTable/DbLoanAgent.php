...
class Application_Model_DbTable_DbLoanAgent extends Zend_Db_Table_Abstract
{

    protected $_name = 'cs_loan_agent';
    ...
    function getLoanDataByUserId($user_id, $month=""){
    	...
    	$db = $this->getAdapter();
    	$sql = "SELECT l.`id`,l.`currencyType`,l.`loanDate`,l.`amount`,u.`name` AS user_name  
    			FROM ". $this->_name ." AS l INNER JOIN
    					cs_agents AS u ON(l.agent_id=u.id)  
    			WHERE ". $where . " ORDER BY id, agent_id";
//     	echo $sql; exit;
