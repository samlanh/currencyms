	...
	public function FrmAddExpense($data=null){
	  $request=Zend_Controller_Front::getInstance()->getRequest();
		...
		$_title->setAttribs(array('dojoType'=>$this->tvalidate,
				'onkeyup'=>'this.submit()',
				'placeholder'=>$this->tr->translate("SEARCH SALARY EXPENSE")
		));
	   ...
	   // $for_date->setValue($request->getParam('for_date'));
		...
		$for_date_search->setAttribs(array(
				'dojoType'=>'dijit.form.FilteringSelect',
				'class'=>'fullside'
		));
		$dg = new Application_Model_DbTable_DbGlobal();
		...
		$this->addElements(array($account_name,$_Date ,$_stutas,$_Description,$total_amount,$_title,$_btn_search,$_status_search,$for_date_search,$currency_type,
				$for_date,$id));
		return $this;
