<?php 
Class Accounting_Form_Frmindex extends Zend_Dojo_Form {
	protected $tr;
...
// 		$for_date->setValue($request->getParam('for_date'));
		...
		$this->addElements(array($account_name,$_Date ,$_stutas,$total_amount,$_title,$_btn_search,$_status_search,$for_date_search,$currency_type,
